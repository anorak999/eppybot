...
OUTDIR="$ROOTDIR/dist-deb"

if [[ ! -f "$ROOTDIR/eppybot.py" ]]; then
...
install -m 0644 "$ROOTDIR/eppybot.py" "$PKGROOT/opt/eppybot/eppybot.py"
install -m 0644 "$ROOTDIR/eppybot_icon.png" "$PKGROOT/usr/share/pixmaps/eppybot.png"
install -m 0644 "$WORKDIR/eppybot.desktop" "$PKGROOT/usr/share/applications/eppybot.desktop"
